...
#                             #print(f"slice_data.shape {slice_data.shape}")
#                             print(f"slice_name={slice_name} chn={chn} shape={slice_data.shape} dims={getattr(ds[slice_name], 'dims', None)}")
#                             print(ds[slice_name])   # shows coords/dims for this variable
